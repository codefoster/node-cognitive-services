import { entityLinking } from "../../src";
const config = require('../config.js');
const should = require('should');

describe('Entity linking', () => {

    let entityLinkingClient = new entityLinking({
    ...
    describe('Link entity', () => {
        it('should return response', (done) => {
            ...
            entityLinkingClient.linkEntity({
                parameters: {offset: '0'},
                headers: {"Content-Type": "text/plain"},
                body: "For months, the four scientific instruments at the heart of the James Webb Space Telescope have been sealed in what looks like a huge pressure cooker. It's a test\
